...
import type { Collider, ColliderDesc, Rotation, Shape} from "@dimforge/rapier3d-compat";
...
//
export function isOverlapping(world: RapierWorld, pos: THREE.Vector3, rotation: Rotation, shape: Shape, collider: Collider, rigidBody: RapierRigidBody): ObjectOverlap {
