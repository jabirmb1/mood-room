...
//
export function getRigidBodyRotation(rigidBodyRef: React.RefObject<RapierRigidBody | null>): RotationDegrees {
...
//
export function setRigidBodyRotation( body: RapierRigidBody | null, rotation: RotationDegrees) {
    if (!body) return;
