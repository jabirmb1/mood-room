...
function handlePointerMove(e: ThreeEvent<PointerEvent>,   rigidBodyRef: React.RefObject<RapierRigidBody | null>, 
  objectRef: React.RefObject<THREE.Object3D | null>,  world:RapierWorld,plane: React.RefObject<THREE.Plane>,  
  dragOffset: React.RefObject<THREE.Vector3>,dragging: boolean, isHorizontalMode: boolean){
  ...
  export function useDragControls({rigidBodyRef, objectRef, enabled, isHorizontalMode, onStart, onEnd}:
    ...
    return {
        ...
        onPointerMove: useCallback(
          (e) => handlePointerMove(e,rigidBodyRef, objectRef, world, plane, dragOffset, dragging, isHorizontalMode),
